...
export default function Transcribing(props) {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-10 md:gap-14 text-center pb-24 p-4">
      ...
      <div className="flex flex-col gap-2 sm:gap-3 max-2-[400px] mx-autp w-full">
        {[0, 1, 2].map((val) => {
          return (
            <div
              key={val}
